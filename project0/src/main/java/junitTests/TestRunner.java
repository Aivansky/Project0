	...
	@Test
		...
		@Test
		  public void testAssertDepositHasItems() {
		    assertThat(Arrays.asList(transactions.util.Transactions.deposits), hasItems());
		  ...
		  @SuppressWarnings({ "deprecation", "unchecked" })
			@Test
			  public void testAssertWithdrawsHasItems() {
			    assertThat(Arrays.asList(transactions.util.Transactions.withdraws), hasItems());
		...
		@Test
		 public void depositTest() {
			...
			user.AccDeposit(500);
			assertTrue(true);
			System.out.println("If true 500 is deposited");
		  }
		...
		@Test
		 public void withdrawTest() {
			...
			assertTrue(true);
			System.out.println("If true will throw message of unable to withdraw to negative");
		  }
		...
		@Test
		 public void withdrawTest2() {
			...
			user.AccWithdraw(500);
			assertTrue(true);
			System.out.println("If true 600-500 leaves 100 in balance");
		  }
